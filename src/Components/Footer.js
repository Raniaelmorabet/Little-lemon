            ...
            <div id='mainContainer' className='flex bg-light-brown w-[100%] py-[60px] h-[500px]'>
                <div>
                    <ul className='text-white space-y-6 my-16 mx-44 font-Karla text-xl'>
                        <li><Link to="navBar" smooth={true} style={{ cursor: 'pointer' }}>Home</Link></li>
                        <li><Link to="aboutSection" offset={-170} smooth={true} style={{ cursor: 'pointer' }}>About</Link></li>
                        <li><Link to="menuContainer" offset={40} smooth={true} style={{ cursor: 'pointer' }}>Menus</Link></li>
                        <li><Link to="TestimonialContainer" offset={-350} smooth={true} style={{ cursor: 'pointer' }} >Testimonials</Link></li>
                        <li><Link to="navBar" smooth={true} style={{ cursor: 'pointer' }}>Order</Link></li>
                        <li><Link to="navBar" smooth={true} style={{ cursor: 'pointer' }}>Login</Link></li>
                    </ul>
                </div>
                <div id='box'
                     className='flex justify-center items-center mx-14 my-8 bg-dark-brown w-[40%] h-[350px] border-black border-[2px]'>
                    <div className='mb-[20px]'>
                        <img src={logo} className='flex justify-center items-center mx-auto w-60 my-3'/>
                ...
                <div>
                    <ul className='text-white space-y-6 my-16 mx-44 font-Karla text-xl'>
                        ...
                        <li><a href='https://twitter.com/RANIAELMORABET7' target='_blank'>Twitter</a></li>
                        <li><a href='https://www.youtube.com' target='_blank'>Youtube</a></li>
                        <li><a href='https://www.linkedin.com/in/rania-elmorabet/' target='_blank'>Linkedin</a></li>
